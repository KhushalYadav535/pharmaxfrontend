...
const CanvasRevealEffect = ({
  ...
  return (
    ...
    >
      ...
      {showGradient && (
        <div className="absolute inset-0 bg-gradient-to-t from-[#0B3B2E] to-[84%]" />
      )}
    </div>
  );
};
...
export function Footer({
  ...
  return (
   <footer className="w-full bg-[#0B3B2E] text-white relative z-50 overflow-hidden">
      <div className="w-full py-8 min-[1250px]:py-16 relative">
        <div className="text-center mb-8 min-[1250px]:mb-16">
          <h2 className="text-4xl min-[1250px]:text-7xl font-light leading-tight font-display">
            {heading.line1}<br />
            {heading.line2}<br />
            <span className="text-emerald-400 font-bold">{heading.line3}</span>
          </h2>
        </div>

        <div className="grid grid-cols-1 min-[1250px]:grid-cols-12 min-[1250px]:grid-rows-2 border-t border-b border-emerald-950/20">

          <div className="flex min-[1250px]:hidden border-b border-emerald-950/20">
            {socialLinks.slice(0, 2).map((link, i) => (
              <AnimatedIconLink
                ...
                className={cn(
                  "flex-1 py-6 flex items-center justify-center hover:bg-white/5",
                  i < socialLinks.length - 1 ? "border-r border-emerald-950/20" : ""
                )}
              />
            ))}
          </div>
          ...
          {socialLinks.slice(0, 2).map((link, i) => (
            <AnimatedIconLink
              ...
              ariaLabel={link.ariaLabel}
              className={cn(
                "hidden min-[1250px]:flex min-[1250px]:col-span-1 min-[1250px]:row-span-1 border-b border-emerald-950/20 py-8 items-center justify-center hover:bg-white/5",
                i === 0 ? "border-r border-emerald-950/20" : "border-r border-emerald-950/20"
              )}
            />
          ))}

          <div className="h-40 min-[1250px]:h-auto min-[1250px]:col-span-8 min-[1250px]:row-span-1 border-b border-emerald-950/20 min-[1250px]:border-r border-emerald-950/20 relative">
            <CanvasRevealEffect
              animationSpeed={3}
              containerClassName="bg-[#0B3B2E] absolute inset-0 pointer-events-none"
              colors={[
          ...
          <div className="grid grid-cols-2 min-[1250px]:hidden border-b border-emerald-950/20">
            {links.slice(0, 4).map((link, i) => (
              <AnimatedLink
                key={link.label}
                href={link.href}
                className={cn(
                  "py-6 flex items-center justify-center text-sm text-white hover:text-emerald-400 hover:bg-white/5 transition-colors w-full",
                  i % 2 === 0 ? "border-r border-emerald-950/20" : "",
                  i < 2 ? "border-b border-emerald-950/20" : ""
                )}
              >
                {link.label}
              </AnimatedLink>
          ...
          {links.slice(0, 2).map((link, i) => (
            <AnimatedLink
              ...
              href={link.href}
              className={cn(
                "hidden min-[1250px]:flex min-[1250px]:col-span-1 min-[1250px]:row-span-1 border-b border-emerald-950/20 py-8 items-center justify-center text-sm text-white hover:text-emerald-400 hover:bg-white/5 transition-colors w-full",
                i === 0 ? "border-r border-emerald-950/20" : ""
              )}
            >
              {link.label}
            </AnimatedLink>
          ...
          <div className="px-4 py-6 min-[1250px]:py-8 min-[1250px]:col-span-9 min-[1250px]:row-span-1 border-b min-[1250px]:border-b-0 min-[1250px]:border-r border-emerald-950/20 text-sm text-emerald-100/70 leading-relaxed bg-[#0A3128]/50">
          ...
          {links.slice(2, 5).map((link, i) => (
            <AnimatedLink
              ...
              href={link.href}
              className={cn(
                "hidden min-[1250px]:flex min-[1250px]:col-span-1 min-[1250px]:row-span-1 py-8 items-center justify-center text-sm text-white hover:text-emerald-400 hover:bg-white/5 transition-colors w-full",
                i < 2 ? "border-r border-emerald-950/20" : ""
              )}
            >
              {link.label}
            </AnimatedLink>
